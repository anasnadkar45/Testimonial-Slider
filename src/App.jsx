...
function App() {
  return (
    <div className='flex items-center justify-center bg-gradient-to-t to-violet-950 from-violet-400 w-[100vw] h-[100vh] '>
      <div className='flex flex-col justify-center items-center'>
        <h1 className='font-bold text-center text-4xl'>Our Testimonials</h1>
        <div className='h-2 w-1/5 bg-violet-500 rounded-full'></div>
